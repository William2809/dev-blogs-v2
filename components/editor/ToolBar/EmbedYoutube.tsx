    ...
    return <div onKeyDown={({ key }) => {
        ...
        {visible && <div className='absolute top-full mt-4 z-50 right-0'>
            <div className='flex space-x-2'>
                <input
                    autoFocus
                    type="text" className=' bg-transparent rounded border-2 border-secondary-dark focus:border-primary-dark dark:focus:border-primary transition p-2 text-primary-dark dark:text-primary'
